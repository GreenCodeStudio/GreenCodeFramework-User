...
module.exports = class extends BaseSeleniumTest {
    ...
    async mainTest() {
        ...
        expect(this.driver.findElement(By.css('.UsersList')).getText()).to.not.contain('TestName')
        expect(this.driver.findElement(By.css('.UsersList')).getText()).to.not.contain('test@test.example')
        ...
        expect(this.driver.findElement(By.css('.UsersList')).getText()).to.contain('TestName')
        expect(this.driver.findElement(By.css('.UsersList')).getText()).to.contain('test@test.example')
    }
}